...
impl AppPaths {
    pub fn resolve() -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            default_codex_hooks: home.join(".codex").join("hooks.json"),
            ...
            monitor_dir: data_dir.join("monitor"),
            hook_events_file: data_dir.join("monitor").join("hook-events.jsonl"),
            config_dir,
            data_dir,
        })
    }
